...
## Context
CRAP (RFC 0005 §7) needs per-function coverage. Measuring coverage requires *executing* tests —
...
usable coverage, CRAP degrades as specified in RFC 0005 §7 (cov = 0, flagged `coverage: none`).
