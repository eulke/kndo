...
This is the one guide to writing a kndo extension: the ABI you implement, how identity,
activation and dependencies work, and the testing standard a plugin is held to before it
ships.
