...
/// JS/TS generated-file conventions (spec §1's first-comment markers, RFC 0012 §7): the
...
/// stays a documented gap: it needs cross-file knowledge no single-file hook has (RFC 0012 §7).
