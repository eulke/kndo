...
/// Same isolation reasoning as the adapter-tier test: a process-unique target dir per demo
/// build keeps concurrent test binaries from racing on shared artifacts.
