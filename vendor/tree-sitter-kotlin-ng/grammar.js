...
module.exports = grammar({
  ...
  rules: {
    ...
    when_entry: $ => seq(
      choice(
        // Kotlin 2.1's guard: `is String if x.isEmpty() -> …`. The language
        // allows it on an entry with ONE condition, which is also what keeps
        // it apart from an `if` expression opening the next condition after a
        // comma.
        seq(
          field('condition', $._when_condition),
          'if',
